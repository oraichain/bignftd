module github.com/oraichain/wasmd/tests/interchaintest
...
replace (
	...
	// orai chain fork
	github.com/cometbft/cometbft => github.com/oraichain/cometbft v0.38.6-0.20241009085905-40f11e6d3a5b
